        ...
        >
            ...
            <CardContent className="p-4 space-y-3">
                ...
                <button
                    ...
                    className={`w-full font-semibold py-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg active:scale-95 ${isAdmin
